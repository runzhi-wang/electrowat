...
const I18N = {
  zh: {
    ...
    "hero.lead2":
      "作为面向 AI4Science 的专业数据基础设施，ElectroWat DB 可系统支持从污染物降解动力学参数预测、电极与工艺协同优化，到反应路径推与及机制解析，乃至领域知识网络与研究趋势的定量洞察。通过提供严格标准化与质量控制的可计算数据集，我们不仅为机器学习驱动的科学发现提供关键支撑，更致力于推动环境电化学领域从经验试错向数据驱动的科研范式转变，最终加速可持续水处理技术的创新与应用。",
    "hero.fair":
