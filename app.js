...
const I18N = {
  zh: {
    ...
    "hero.lead2":
      "作为面向 AI4Science 的专业数据基础设施，ElectroWat DB 可系统支持污染物降解动力学参数预测、电极与工艺协同优化、反应路径推理与机制解析，以及研究趋势分析。通过提供严格标准化与质量控制的可计算数据集，我们不仅赋能机器学习驱动的科学发现，更致力于推动环境电化学领域从经验试错向数据驱动的科研范式转变，最终加速可持续水处理技术的创新与应用。",
    "hero.cta1": "检索数据集",
    "hero.cta2": "如何引用",
    "stat.records": "实验记录",
